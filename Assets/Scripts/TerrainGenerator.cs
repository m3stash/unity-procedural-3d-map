...
public class TerrainGenerator : MonoBehaviour {
            ...
            for (int xOffset = -chunksVisibleInViewDst; xOffset <= chunksVisibleInViewDst; xOffset++) {
                ...
                if (!alreadyUpdatedChunkCoords.Contains(viewedChunkCoord)) {
                    if (terrainChunkDictionnary.ContainsKey(viewedChunkCoord)) {
                        ...
                        terrainChunkDictionnary.Add(viewedChunkCoord, newChunk);
                        newChunk.onVisibilityChange += OnTerranChunkVisibilityChanged;
                        newChunk.Load();
                    }
                }
            }
    ...
    void OnTerranChunkVisibilityChanged(TerrainChunk chunk, bool isVisible) {
        if (isVisible) {
